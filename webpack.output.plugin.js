...
class WebpackOutputPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.done.tap('WebpackOutputPlugin', (stats) => {
            if (stats.hasErrors()) {
                return false
            }
    ...
    statsTable(data) {
        ...
        for (const asset of assets) {
            table.push([chalk.red(asset.name), formatSize(asset.size)])
        }
...
module.exports = WebpackOutputPlugin
